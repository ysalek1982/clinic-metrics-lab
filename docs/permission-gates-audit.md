...
Generado: 2026-05-23T14:19:25.789Z

- Artifact: `artifacts/security/permission-gates-2026-05-23T14-19-25-786Z.json`
...
|---|---:|---:|
| Protegida por UI | 8 | 0 |
| Limitada/Proximamente | 5 | 0 |
...
|---|---|---|---|
| `src/pages/app/Dashboard.tsx:136` | Protegida por UI | medium | `<Link to="/app/reports">Generar informe</Link>` |
...
| `src/pages/app/SaasAdmin.tsx:574` | Protegida por UI | critical | `deactivateInviteMutation.mutate(invite.id);` |
| `src/pages/app/SaasAdmin.tsx:1170` | Limitada/Proximamente | critical | `<Button size="sm" variant="outline" onClick={onDeactivate} disabled={busy \|\| invite.status !== "active"}>` |
...
| `src/components/layout/AppTopbar.tsx:266` | Protegida por UI | medium | `<Link to="/onboarding">Crear nuevo tenant</Link>` |
