...
export const SUBSCRIPTION_PLANS: SubscriptionPlan[] = [
  {
    id: "free",
    name: "Free",
    marketPosition: "Cuenta gratuita basica",
    monthlyPriceUsd: 0,
    includedUsers: 1,
    activePatientLimit: 25,
    branchLimit: 1,
    enabledPackLimit: 2,
    aiEnabled: false,
    whiteLabelEnabled: false,
    features: ["Dashboard basico", "Pacientes limitados", "Antropometria basica", "Agenda basica"],
  },
  {
    id: "courtesy",
    name: "Cortesia",
    marketPosition: "Cortesia administrada por plataforma",
    monthlyPriceUsd: 0,
    includedUsers: 5,
    ...
    aiEnabled: true,
    whiteLabelEnabled: false,
    features: ["Acceso temporal", "Reportes limitados", "Copilot contextual", "Packs segun rol"],
  },
  {
    id: "pro",
    name: "Pro",
    marketPosition: "Profesional individual",
    monthlyPriceUsd: 49,
    includedUsers: 3,
    ...
    aiEnabled: true,
    whiteLabelEnabled: false,
    features: ["Pacientes", "Agenda", "Labs", "Reportes", "Copilot contextual", "Nutricion operativa"],
  },
  {
    id: "clinic_hospital",
    name: "Clinic/Hospital",
    marketPosition: "Institucional multiusuario",
    monthlyPriceUsd: 199,
    includedUsers: 25,
    ...
    features: ["Multiusuario", "Roles", "Auditoria", "Enteral", "Parenteral basico", "Labs", "Reportes"],
  },
  {
    id: "trial",
    name: "Trial legacy",
    marketPosition: "Compatibilidad legacy; usar Pro para nuevas altas",
    monthlyPriceUsd: 0,
    includedUsers: 8,
    activePatientLimit: 500,
    branchLimit: 2,
    ...
    aiEnabled: true,
    whiteLabelEnabled: false,
    features: ["Legacy", "Migrar a Pro"],
  },
  {
    id: "starter",
    name: "Starter legacy",
    marketPosition: "Compatibilidad legacy; usar Free o Pro para nuevas altas",
    monthlyPriceUsd: 89,
    includedUsers: 3,
    activePatientLimit: 250,
    branchLimit: 1,
    ...
    aiEnabled: false,
    whiteLabelEnabled: false,
    features: ["Legacy", "Migrar a Free/Pro"],
  },
  {
    id: "professional",
    name: "Professional legacy",
    marketPosition: "Compatibilidad legacy; usar Pro",
    monthlyPriceUsd: 249,
    includedUsers: 12,
    ...
    aiEnabled: true,
    whiteLabelEnabled: false,
    features: ["Legacy", "Mapea a Pro"],
  },
  {
    id: "clinic",
    name: "Clinic legacy",
    marketPosition: "Compatibilidad legacy; usar Pro o Clinic/Hospital",
    monthlyPriceUsd: 179,
    includedUsers: 8,
    activePatientLimit: 800,
    branchLimit: 2,
    enabledPackLimit: 5,
    aiEnabled: true,
    whiteLabelEnabled: false,
  ...
  {
    id: "hospital",
    name: "Hospital legacy",
    marketPosition: "Compatibilidad legacy; usar Clinic/Hospital",
    monthlyPriceUsd: 599,
    includedUsers: 40,
    activePatientLimit: 5000,
    branchLimit: 6,
    ...
    aiEnabled: true,
    whiteLabelEnabled: true,
    features: ["Legacy", "Mapea a Clinic/Hospital"],
  },
  {
    id: "enterprise",
